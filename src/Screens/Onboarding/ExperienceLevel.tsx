...
const ExperienceLevel = () => {
  ...
  const handleNext = async () => {
    setIsLoading(true);
    try {
      await updateMe({ experienceLevel: selectedLevel.toLowerCase() });
      navigation.navigate("OnboardingWorking");
    } catch (err: any) {
  ...
  const levels = [
    {
      id: 1,
      title: "Beginner",
      subtitle: "New to the game",
      image: require("../../assets/big.png"),
    },
    {
      id: 2,
      title: "Intermediate",
      subtitle: "Got the basics down",
      image: require("../../assets/inter.png"),
    },
    {
      id: 3,
      title: "Advanced",
      subtitle: "Refining elite skills",
      image: require("../../assets/advanc.png"),
    },
  ];
    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.progressBar}>
          <View style={[styles.fill, { width: "60%", backgroundColor: primaryColor }]} />
        </View>

        <Text style={styles.title}>Where are you at right now?</Text>

        <Text style={styles.subtitle}>Pick the level that fits you best.</Text>
