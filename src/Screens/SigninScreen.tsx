  ...
  const handleSocialSignIn = async (
    ...
    try {
      ...
      const msg =
        ...
        (err?.response?.status === 403 ? "Your account has been suspended" : null) ||
        err?.message ||
            ...
            <View style={styles.contentContainer}>
              ...
              <View style={styles.formContainer}>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => handleSocialSignIn(startGoogleOAuth, "google")}
                ...
                <TouchableOpacity
                  activeOpacity={0.8}
                  style={styles.socialButton}
                  onPress={() => handleSocialSignIn(startFacebookOAuth, "facebook")}
                  disabled={socialLoading !== null}
                >
                ...
                <TouchableOpacity
                  activeOpacity={0.8}
                  style={styles.socialButton}
                  onPress={() => handleSocialSignIn(startAppleOAuth, "apple")}
                  disabled={socialLoading !== null}
                >
                  {socialLoading === "apple" ? (
                    <ActivityIndicator color={colors.text} size="small" />
