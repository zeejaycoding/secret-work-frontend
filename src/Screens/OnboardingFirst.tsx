        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.bottomContent}>
            ...
            <Text style={styles.title}>
              Train Like It <Text style={[styles.redText, { color: primaryColor }]}>Matters</Text>
            </Text>

            <Text style={styles.description}>
              Access focused drills and real training built to improve your
              game, not waste your time.
            </Text>
